...
def calculate_transition_parameter(train_y,tag_list,tag_dict):
    ...
    for i in range(len(train_y)-1):
        if [train_y[i],train_y[i+1]] not in tagpair_list:
            ...
            transition_parameter[train_y[i]][1][T_id]=\
                float(np.log(train_y_set.count([train_y[i],train_y[i+1]]) / train_y.count(train_y[i])))
...
if __name__ == '__main__':
    path_sg_train = "/Users/hehe/Desktop/ML/project/SG/train"
    path_sg_in = "/Users/hehe/Desktop/ML/project/SG/dev.in"
    path_sg_out = "/Users/hehe/Desktop/ML/project/SG/dev.out"
    modified_train_path = "/Users/hehe/Desktop/ML/project/sg_train_modified"
    modified_train_path_tr = "/Users/hehe/Desktop/ML/project/sg_train_modified_tr"
    predicted_out_path = "/Users/hehe/Desktop/ML/project/SG/dev.p3.out"
    #

    train_lines = open(path_sg_train, encoding='utf8').read().splitlines()
    in_lines = open(path_sg_in, encoding='utf8').read().splitlines()
