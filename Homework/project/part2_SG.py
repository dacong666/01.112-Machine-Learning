...
if __name__ == '__main__':
    path_sg_train = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/SG/train"
    path_sg_in = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/SG/dev.in"
    path_sg_out = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/SG/dev.out"
    modified_train_path = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/SG/sg_train_modified"
    predicted_out_path = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/SG/dev.p2.out"

    train_lines = list(filter(None, open(path_sg_train, encoding='utf8').read().splitlines()))
    # in_lines = list(filter(None, open(path_sg_in, encoding='utf8').read().splitlines()))
    in_lines = open(path_sg_in, encoding='utf-8').read().splitlines()


    train_sg_data = [line.split() for line in train_lines]
    train_sg_x = [line[0] for line in train_sg_data if line]
    train_sg_y = [line[-1] for line in train_sg_data if line]

    train_data, train_x, train_y = modify_train_data(train_sg_x, train_sg_y, modified_train_path)
