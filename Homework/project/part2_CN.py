...
if __name__ == '__main__':
    path_cn_train = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/CN/train"
    path_cn_in = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/CN/dev.in"
    path_cn_out = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/CN/dev.out"
    modified_train_path = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/CN/cn_train_modified"
    predicted_out_path = "C:/Users/87173/Desktop/term6/Machine Learning/Homework/project/CN/dev.p2.out"
    #

    train_lines = list(filter(None, open(path_cn_train, encoding='utf8').read().splitlines()))
    # in_lines = list(filter(None, open(path_cn_in, encoding='utf8').read().splitlines()))
    in_lines = open(path_cn_in, encoding='utf-8').read().splitlines()
